...
@WebServlet(
        name = "assignment7b",
        urlPatterns = {"/assignment7b"}
    )
public class assignment7b extends HttpServlet
{
 
// Location of servlet.
static String Domain  = "cs.gmu.edu:8443";
static String Path    = "/offutt/servlet/";
static String Servlet = "assignment7b";
...
private void PrintHead (PrintWriter out)
{
   ...
   out.println("<head>");
   out.println("<title>Assignment seven</title>");
...
private void PrintBody (PrintWriter out, String newStr, String rhs, String rslt)
{
   ...
   out.println(" action=\"/assignment7b\">");
   out.println("");
   out.println(" <table>");
   out.println("  <tr>");
