...
private void PrintBody (PrintWriter out, String lhs, String rhs, String rslt)
{
   ...
   out.println("</p>");
   out.println("<p>");
   out.println("1.How are the values in the local variable and the class instance variable different?");
   out.println("</p>");
   out.println("<p>");
